 ...
 */
public class BroadcastFilesAction extends AbstractGuiAction {
    private CleanUpListener cleanUpListener = new CleanUpListener();
    private JInternalFrame frame;

    public BroadcastFilesAction(GuiContext ctxt) {
        super(ctxt, "Fichiers et Sections", "Paramétrage des fichiers à exporter", null,
            "ParamExportFileSections");
    }
    ...
    private void displayNewWindow() {
        try {
            frame = new BroadcastFilesWindow(getGuiContext());
    ...
    private class CleanUpListener extends InternalFrameAdapter {
        ...
        public void internalFrameClosed(InternalFrameEvent event) {
            ...
            frame = null;
            System.out.println("RELEASED FRAME");
        }
